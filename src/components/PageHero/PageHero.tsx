...
export default function PageHero({ icon: Icon, tag, title, accent, description, breadcrumb, gradient }: PageHeroProps) {
  return (
    <section className={styles.hero} style={gradient ? ({ '--hero-gradient': gradient } as React.CSSProperties) : {}}>
