        ...
        >
          <div className={styles.brand}>
            <Link to="/" className={styles.logo}>
              <img src={logoWhite} alt="E-Connect Solutions" className={styles.logoImg} />
            </Link>
            ...
            <div className={styles.socialLinks}>
              <a href="https://www.facebook.com/espludaipur/" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="Facebook"><FiFacebook size={15} /></a>
              <a href="https://twitter.com/esplrajasthan" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="Twitter"><FiTwitter size={15} /></a>
              <a href="https://at.linkedin.com/company/e-connectsolutions-pvt.-limited" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="LinkedIn"><FiLinkedin size={15} /></a>
            </div>
          </div>
              ...
              {offerings.map(item => (
                <li key={item.label}>
                  <Link to={item.path} className={styles.colLink}>
                    <FiArrowRight size={11} className={styles.colLinkIcon} />{item.label}
                  </Link>
                </li>
              ))}
            </ul>
              ...
              {quickLinks.map(link => (
                <li key={link.path}>
                  <Link to={link.path} className={styles.colLink}>
                    <FiArrowRight size={11} className={styles.colLinkIcon} />{link.label}
                  </Link>
                </li>
              ))}
            </ul>
          ...
          <div className={styles.col}>
            ...
            <div className={styles.contactList}>
              ...
              <div className={styles.contactItem}>
                ...
                <a href="mailto:sales@e-connectsolutions.com" className={styles.contactLink}>sales@e-connectsolutions.com</a>
              </div>
            </div>
            <div className={styles.newsletter}>
              ...
              <div className={styles.newsletterForm}>
                ...
                <button className={styles.newsletterBtn} aria-label="Subscribe"><FiArrowRight size={15} /></button>
              </div>
            </div>
          </div>
        </motion.div>
