...
import { Cloud, Server, Layers, Monitor, Database, ArrowRight, ChevronRight, type LucideIcon } from 'lucide-react'
...
function ProductCard({ product, index, inView }: ProductCardProps) {
  const { icon: Icon, color, gradient, title, category, shortDesc, badge, slug } = product

  return (
    <motion.div
      className={styles.card}
      style={{ '--c': color, '--g': gradient } as React.CSSProperties}
