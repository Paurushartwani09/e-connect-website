...
import {
  ...
  FiServer, FiWifi, FiLock, FiSmartphone, FiLayers, FiMail,
  type IconType
} from 'react-icons/fi'
...
function ServiceCard({ svc, index, isActive, onToggle }: ServiceCardProps) {
  ...
  return (
    <motion.div
      ...
      style={{ '--card-color': svc.color, '--card-gradient': svc.gradient } as React.CSSProperties}
    >
