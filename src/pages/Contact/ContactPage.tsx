...
export default function ContactPage() {
  ...
  const handleSubmit = (ev: React.FormEvent<HTMLFormElement>) => {
    ...
    emailjs
      ...
      .catch(() => { setSending(false); setSendError('Something went wrong. Please try again or email us directly.') })
  }
  ...
  const handleChange = (ev: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    if (errors[ev.target.name as keyof FormErrors]) {
              ...
              {submitted ? (
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() => { setSubmitted(false); setSendError(''); setForm({ name:'',email:'',phone:'',company:'',service:'',message:'' }) }}
                  >
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  <div className={styles.formRow}>
                    <div className={styles.formGroup}>
                      <label htmlFor="name" className={styles.label}><FiUser size={13} /> Full Name *</label>
                    ...
                    <div className={styles.formGroup}>
                      <label htmlFor="email" className={styles.label}><FiMail size={13} /> Email Address *</label>
                  ...
                  <div className={styles.formRow}>
                    <div className={styles.formGroup}>
                      <label htmlFor="phone" className={styles.label}><FiPhone size={13} /> Phone Number</label>
                    ...
                    <div className={styles.formGroup}>
                      <label htmlFor="company" className={styles.label}><FiBriefcase size={13} /> Company / Organization</label>
                  ...
                  <div className={styles.formGroup}>
                    <label htmlFor="service" className={styles.label}><FiSettings size={13} /> Service Interested In</label>
                  ...
                  <div className={styles.formGroup}>
                    <label htmlFor="message" className={styles.label}><FiMessageSquare size={13} /> Message *</label>
            ...
            >
              <div className={styles.infoCard}>
                ...
                <div className={styles.socialLinks}>
                  <a href="https://www.facebook.com/espludaipur/" target="_blank" rel="noopener noreferrer" className={styles.socialLink} style={{ '--sl': '#1877F2' } as React.CSSProperties}>
                    <FiFacebook size={18} /><span>Facebook</span>
                  </a>
                  <a href="https://twitter.com/esplrajasthan" target="_blank" rel="noopener noreferrer" className={styles.socialLink} style={{ '--sl': '#1DA1F2' } as React.CSSProperties}>
                    <FiTwitter size={18} /><span>Twitter</span>
                  </a>
                  <a href="https://at.linkedin.com/company/e-connectsolutions-pvt.-limited" target="_blank" rel="noopener noreferrer" className={styles.socialLink} style={{ '--sl': '#0A66C2' } as React.CSSProperties}>
