...
import {
  ...
  FiArrowRight, FiCalendar, FiMapPin, FiMail,
  FiTarget, FiZap, FiShield, type IconType
} from 'react-icons/fi'
      ...
      <div className={styles.container}>
        <div className={styles.missionGrid}>
          <motion.div
            ...
            style={{ '--mc': '#0057FF' } as React.CSSProperties}
          ...
          <motion.div
            className={styles.missionCard}
            style={{ '--mc': '#00B894' } as React.CSSProperties}
            initial={{ opacity: 0, y: 40 }}
            animate={inView ? { opacity: 1, y: 0 } : {}}
          ...
          <motion.div
            className={styles.missionCard}
            style={{ '--mc': '#7B61FF' } as React.CSSProperties}
            initial={{ opacity: 0, y: 40 }}
            animate={inView ? { opacity: 1, y: 0 } : {}}
