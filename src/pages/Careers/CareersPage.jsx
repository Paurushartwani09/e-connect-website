...
const openings = [
  {
    ...
    desc: 'Build and maintain high-performance web and mobile applications for our enterprise clients and government platforms. You will work closely with backend teams and UX designers to deliver world-class user experiences.',
    responsibilities: [
  ...
  },
  {
    ...
    desc: "Design, develop, and maintain scalable backend services and APIs powering our ERP, e-Governance, and M-SaaS platforms. You'll be part of agile squads delivering complex enterprise projects.",
    responsibilities: [
  ...
  },
  {
    ...
    desc: 'Own the CI/CD pipelines, cloud infrastructure, and deployment automation for our SaaS products and government cloud deployments. You will ensure our platforms are highly available, secure, and cost-efficient.',
    responsibilities: [
  ...
  },
  {
    ...
    desc: 'Bridge the gap between clients and engineering teams. You will work directly with government departments and enterprise clients to capture requirements, create functional specs, and ensure successful delivery.',
    responsibilities: [
  ...
  },
  {
    ...
    desc: "Protect our clients' digital infrastructure through proactive vulnerability assessments, penetration testing, and security monitoring. You will implement security frameworks aligned with ISO 27001 and CERT-In guidelines.",
    responsibilities: [
  ...
  },
  {
    ...
    desc: 'Create intuitive, beautiful, and accessible user interfaces for our enterprise web and mobile products. You will own the design language across our product suite and collaborate closely with engineering for pixel-perfect delivery.',
    responsibilities: [
    ...
    <section className={styles.cultureSection} ref={ref}>
      <div className={styles.container}>
        <motion.div className={styles.sectionHeader}
          ...
          <p className={styles.sectionSub}>We don&apos;t just build software — we build careers. Here&apos;s what makes E-Connect a great place to grow.</p>
        </motion.div>
        ...
        <div className={styles.perksGrid}>
          {perks.map((perk, i) => {
            ...
            return (
              <motion.div key={perk.title} className={styles.perkCard} style={{ '--pc': perk.color }}
                  ...
                  <div className={styles.jobLeft}>
                    ...
                    <div className={styles.jobInfo}>
                      ...
                      <div className={styles.jobMeta}>
                        ...
                        <span className={styles.jobMeta2}>
                          <FiMapPin size={11} /> {job.location}
                        </span>
                        <span className={styles.jobMeta2}>
                          <FiClock size={11} /> {job.exp}
                        </span>
                            ...
                            <ul className={styles.jobList}>
                              {job.responsibilities.map(r => (
                                <li key={r} className={styles.jobListItem}>
                                  <FiCheckCircle size={13} className={styles.jobCheck} />
                                  {r}
                                </li>
                              ))}
                            </ul>
