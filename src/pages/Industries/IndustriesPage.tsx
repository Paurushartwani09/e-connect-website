          ...
          <div className={styles.explorer}>
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                style={{ '--ic': active.color } as React.CSSProperties}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -20 }}
...
function ProcessesSection({ inView }: ProcessesSectionProps) {
  return (
...
function IndustriesStats({ inView }: IndustriesStatsProps) {
  const stats = [
