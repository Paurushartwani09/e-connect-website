...
import {
  Newspaper, Play, Image as ImageIcon, Download, Calendar, Tag,
  ChevronRight, ArrowRight, ExternalLink, Search,
  Award, Globe, Users, Zap, TrendingUp, Mail,
  FileText, Mic, Video, BookOpen, X, ZoomIn
} from 'lucide-react'
import PageHero from '../../components/PageHero/PageHero'
import styles from './MediaPage.module.css'

/* ─── DATA ─────────────────────────────────────────── */
const categories = ['All', 'Press Release', 'News', 'Awards', 'Events', 'Blog']

const newsItems = [
  {
    id: 1, category: 'Press Release', date: 'May 2025',
    icon: FileText, color: '#0057FF',
    image: 'https://picsum.photos/seed/espl1/600/340',
    title: 'E-Connect Solutions Achieves CMMI Level 5 Re-Certification',
    excerpt: 'E-Connect Solutions Pvt. Ltd. has successfully re-certified to CMMI Level 5, reaffirming its commitment to the highest standards of software process maturity and consistent quality delivery.',
    tag: 'Milestone',
  },
  {
    id: 2, category: 'News', date: 'Apr 2025',
    icon: Globe, color: '#00B894',
    image: 'https://picsum.photos/seed/espl2/600/340',
    title: 'E-Connect Launches Next-Gen E-Governance Platform for Rajasthan Urban Bodies',
    excerpt: 'Our new unified citizen services platform is now live across 15 urban local bodies in Rajasthan, enabling 2M+ citizens to access government services digitally.',
    tag: 'Product Launch',
  },
  {
    id: 3, category: 'Awards', date: 'Mar 2025',
    icon: Award, color: '#FF6B35',
    image: 'https://picsum.photos/seed/espl3/600/340',
    title: 'Recognized as Top IT Solutions Provider — Digital India Summit 2025',
    excerpt: 'E-Connect Solutions was honored at the Digital India Summit for excellence in delivering transformative e-governance and enterprise IT solutions.',
    tag: 'Recognition',
  },
  {
    id: 4, category: 'Events', date: 'Feb 2025',
    icon: Mic, color: '#7B61FF',
    image: 'https://picsum.photos/seed/espl4/600/340',
    title: 'E-Connect at NASSCOM Technology & Leadership Forum 2025',
    excerpt: 'Our leadership team participated in key sessions on Digital Transformation, AI in Governance, and the future of Enterprise IT at NASSCOM TLF 2025.',
    tag: 'Conference',
  },
  {
    id: 5, category: 'Blog', date: 'Jan 2025',
    icon: BookOpen, color: '#E84393',
    image: 'https://picsum.photos/seed/espl5/600/340',
    title: 'The Future of E-Governance: How AI is Transforming Citizen Services',
    excerpt: 'In this blog post, our Chief Business Officer Jaimin Patel explores how AI and intelligent automation are reshaping the way governments interact with citizens.',
    tag: 'Thought Leadership',
  },
  {
    id: 6, category: 'News', date: 'Dec 2024',
    icon: TrendingUp, color: '#0EA5E9',
    image: 'https://picsum.photos/seed/espl6/600/340',
    title: 'E-Connect Crosses 100K Active Users Milestone on Government Platforms',
    excerpt: 'A landmark achievement as our e-governance applications surpass 100,000 daily active users across various government departments and citizen service portals.',
    tag: 'Milestone',
  },
  {
    id: 7, category: 'Press Release', date: 'Nov 2024',
    icon: Zap, color: '#0057FF',
    image: 'https://picsum.photos/seed/espl7/600/340',
    title: 'New M-SaaS Platform Launched for Enterprise Loan Management',
    excerpt: 'E-Connect Solutions launches a fully managed SaaS platform for NBFCs and PF Trusts, featuring AI-powered credit assessment and end-to-end loan lifecycle management.',
    tag: 'Product',
  },
  {
    id: 8, category: 'Events', date: 'Oct 2024',
    icon: Users, color: '#00B894',
    image: 'https://picsum.photos/seed/espl8/600/340',
    title: 'E-Connect Hosts Annual IT Leadership Conclave in Udaipur',
    excerpt: 'Our 3rd Annual IT Leadership Conclave brought together 200+ enterprise technology leaders to discuss Digital Transformation, IT Security, and the Future of Work.',
    tag: 'Event',
  },
  {
    id: 9, category: 'Awards', date: 'Sep 2024',
    icon: Award, color: '#FF6B35',
    image: 'https://picsum.photos/seed/espl9/600/340',
    title: 'Best E-Governance Solution of the Year — SKOCH Award 2024',
    excerpt: 'E-Connect Solutions wins the prestigious SKOCH Award for Best E-Governance Solution for our work on transforming urban local body service delivery in Rajasthan.',
    tag: 'Award',
  },
]

/* Gallery photos — 12 dummy images */
const galleryPhotos = [
    ...
    >
      ...
      <section className={styles.newsSection}>
        <div className={styles.container}>
          ...
          <FilterBar
            categories={categories} active={activeCategory} onSelect={setActiveCategory}
      ...
      <div className={styles.container}>
        <div className={styles.statsGrid}>
          {stats.map(({ icon: Icon, value, label, color }, i) => (
            <motion.div key={label} className={styles.statCard} style={{ '--sc': color }}
...
function FilterBar({ categories, active, onSelect, search, onSearch }) {
  return (
    <div className={styles.filterBar}>
      ...
      <div className={styles.searchBox}>
        ...
        <input type="text" placeholder="Search news, awards…" value={search}
          onChange={e => onSearch(e.target.value)} className={styles.searchInput} />
        {search && (
...
function NewsCard({ item, index, onOpen }) {
  ...
  return (
    <motion.article ref={ref} className={styles.newsCard} style={{ '--nc': item.color }}
      initial={{ opacity: 0, y: 40 }} animate={inView ? { opacity: 1, y: 0 } : {}}
      transition={{ duration: 0.55, delay: index * 0.07, ease: [0.22, 1, 0.36, 1] }}
      whileHover={{ y: -6, transition: { duration: 0.2 } }}
      onClick={onOpen} role="button" tabIndex={0}
      onKeyDown={e => e.key === 'Enter' && onOpen()} aria-label={`Read: ${item.title}`}>
...
/* ─── PHOTO GALLERY ─────────────────────────────────── */
function PhotoGallery({ onOpenPhoto }) {
...
function Lightbox({ item, onClose }) {
  ...
  return (
    <motion.div className={styles.lightboxOverlay}
      ...
      <motion.div className={styles.lightboxCard} style={{ '--nc': item.color }}
...
/* All data and components defined above */